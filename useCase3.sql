-- Use Case: Finalizarea unui Eveniment
...
BEGIN
    ...
    AND (stare IS NULL or stare != 'Finalizat');

    IF v_exista_eveniment = 0 THEN
        RAISE_APPLICATION_ERROR(-20001, 'Eroare: Evenimentul nu există sau este deja finalizat.');
    END IF;
    ...
    IF SQL%ROWCOUNT = 0 THEN
        RAISE_APPLICATION_ERROR(-20002, 'Eroare: Actualizarea stării evenimentului a eșuat.');
    END IF;
